...
class AnalysisDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final remaining =
        record.salary - record.fixed - record.variable - record.bnpl;
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      style: TextStyle(
                          fontSize: 13, color: _riskColor, height: 1.6),
                    )),
                  ],
                ),
              ),
...
class _ExpenseRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final pct = salary > 0 ? ((amount / salary) * 100).round() : 0;
    return Padding(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              value: salary > 0 ? (amount / salary).clamp(0.0, 1.0) : 0,
